...
@push('styles')
<style>
    /* Sticky column shadows for better visual separation */
    ...
    /* Ensure hover state works properly with sticky columns */
                ...
                <div class="inline-block min-w-full align-middle">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="sticky left-0 z-10 bg-gray-50 w-12 px-6 py-3 text-left sticky-shadow-left">
                                ...
                                <th scope="col" class="sticky right-0 z-10 bg-gray-50 px-6 py-3 text-right text-xs font-medium uppercase tracking-wider text-gray-500 sticky-shadow-right">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @forelse($leads as $lead)
                                <tr class="transition-colors hover:bg-gray-50" data-lead-id="{{ $lead->id }}">
                                    <td class="sticky left-0 z-10 bg-white sticky-col whitespace-nowrap px-6 py-4 sticky-shadow-left">
                                    ...
                                    <td class="sticky right-0 z-10 bg-white sticky-col whitespace-nowrap px-6 py-4 text-right text-sm font-medium sticky-shadow-right">
