...
<div class="p-4 border-t border-gray-700 bg-gray-800">
    <!-- User Info -->
    <a href="{{ route('profile.show') }}" class="w-full flex items-center mb-4 px-3 py-3 rounded-lg text-gray-300 hover:bg-blue-900 hover:text-white transition-all duration-200">
